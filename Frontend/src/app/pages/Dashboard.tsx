...
import { chartData, donutData, mockExpenses, formatAmount, getExpenseStats, type ExpenseStatus } from "../mockData"
            ...
            <div className="h-[240px] w-full">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={chartData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                  ...
                  />
                  <Area type="monotone" dataKey="expenses" stroke="#4f46e5" strokeWidth={2.5} fillOpacity={1} fill="url(#colorExp)" activeDot={{ r: 5, strokeWidth: 0, fill: "#4f46e5" }} />
                </AreaChart>
              </ResponsiveContainer>
            </div>
          </CardContent>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-3 pt-4 border-t border-slate-100">
              ...
              {([
                ...
                { label: "Drafts",    count: stats.drafts,    color: "bg-violet-400"  },
